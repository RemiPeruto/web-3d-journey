...
import {Vector3, CannonJSPlugin} from "@babylonjs/core";
import {DisplayedCanvasContainer} from "./displayedCanvas.style";
import {Engine, Scene} from "react-babylonjs";
import * as CANNON from 'cannon';
import {Color3} from "@babylonjs/core/Maths/math.color";
import {PhysicsImpostor} from "@babylonjs/core/Physics/physicsImpostor";
import BouncySphere from "./canvas"; // uses above component in same directory
...
const BabylonCanvas = () => {
    ...
    useEffect(() => {
        ...
        } else if (!faLoaded.current) {
            faLoaded.current = true;
            setFontsReady(true);
        }
    }, []);
    return (
    <DisplayedCanvasContainer>
